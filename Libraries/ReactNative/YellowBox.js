...
// hang on iOS (some sort of overflow maybe). Setting it to Number.MAX_SAFE_INTEGER fixes the iOS issue,
// but since elevation is an Android-only style property let's only use it on Android.
